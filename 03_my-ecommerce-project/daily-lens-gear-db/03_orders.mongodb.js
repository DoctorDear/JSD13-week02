...
db.orders.insertMany([
  ...
  },
  {
    ...
    "equipmentId": ObjectId("65f987654321fedcba543213"),   // Sony FE 24-70mm GM II
  ...
  },
  {
    ...
    "equipmentId": ObjectId("65f987654321fedcba543218"),   // Godox AD200 Pro
  ...
  // 2. Scenario: Pending Order - รอ Admin ตรวจเอกสารยืนยันตัวตน
  {
    ...
    "renterId": ObjectId("65f123456789abcdef012347"),      // วิภาดา รักดี
    "equipmentId": ObjectId("65f987654321fedcba54321e"),   // Canon EOS R5 (Body)
  ...
  // 4. Scenario: Returned Order - คืนของเรียบร้อย เช็กสภาพผ่านและคืนมัดจำแล้ว
  {
    ...
    "renterId": ObjectId("65f123456789abcdef012348"),      // มานะ ขยันยิ่ง
    "equipmentId": ObjectId("65f987654321fedcba543220"),   // Canon EOS C70 Cinema Camera
  ...
  // 5. Scenario: Cancelled Order - การยกเลิกออเดอร์ (ระบุเหตุผลประกอบ เช่น เอกสารยืนยันตัวตนไม่ชัดเจน)
  {
    "_id": ObjectId("65f9be8f123456789abcdef7"),
    "renterId": ObjectId("65f123456789abcdef012345"),      // สมชาย ใจดี
    "equipmentId": ObjectId("65f987654321fedcba543222"),   // Canon RF 70-200mm f/2.8L IS USM
    "startDate": ISODate("2026-07-12T00:00:00Z"),
  ...
  // 6. Scenario: Active Orders with EF Adapter - เช่าเลนส์ EF ไปใช้ร่วมกับ Mount Adapter
  {
    ...
    "renterId": ObjectId("65f123456789abcdef012347"),      // วิภาดา รักดี
    "equipmentId": ObjectId("65f987654321fedcba54321c"),   // Canon EF 50mm f/1.8 STM
  ...
  },
  {
    ...
    "renterId": ObjectId("65f123456789abcdef012347"),      // วิภาดา รักดี
    "equipmentId": ObjectId("65f987654321fedcba54321d"),   // Canon Mount Adapter EF-EOS R
    "startDate": ISODate("2026-07-09T00:00:00Z"),
    "endDate": ISODate("2026-07-12T00:00:00Z"),
    "deposit": 500,
    "status": "active",
